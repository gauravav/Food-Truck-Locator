                ...
                <div className="card">
                    ...
                    <br/>
                        <form className="form" onSubmit={handleSubmitLogin}>
                            ...
                            <input type="username" id="username" name="username" value={formDataLogin.username} onChange={handleInputChangeLogin} required />
                            <label htmlFor="password">Password:</label>
                            <input type="password" id="password" name="password" value={formDataLogin.password} onChange={handleInputChangeLogin} required />
                    ...
                    <br/>
                        <form className="form" onSubmit={handleSubmitRegister}>
                            ...
                            <input type="Name" id="Name" name="Name" value={formDataRegister.Name} onChange={handleInputChangeRegister} required />
                            <label htmlFor="Description">Food Truck Description:</label>
                            <input type="Description" id="Description" name="Description" value={formDataRegister.Description} onChange={handleInputChangeRegister} required />
                            <label htmlFor="Mail">Contact Email:</label>
                            <input type="Mail" id="Mail" name="Mail" value={formDataRegister.Mail} onChange={handleInputChangeRegister} required />
                            <label htmlFor="Website">Food Truck Website:</label>
                            <input type="Website" id="Website" name="Website" value={formDataRegister.Website} onChange={handleInputChangeRegister} required />
                            <label htmlFor="Hours">Open Hours:</label>
                            <input type="Hours" id="Hours" name="Hours" value={formDataRegister.Hours} onChange={handleInputChangeRegister} required />
                            <label htmlFor="Latitude">Location Latitude:</label>
                            <input type="Latitude" id="Latitude" name="Latitude" value={formDataRegister.Latitude} onChange={handleInputChangeRegister} required />
                            <label htmlFor="Longitude">Location Longitude:</label>
                            <input type="Longitude" id="Longitude" name="Longitude" value={formDataRegister.Longitude} onChange={handleInputChangeRegister} required />
                            <label htmlFor="UserID">Food Truck Manager Username:</label>
                            <input type="UserID" id="UserID" name="UserID" value={formDataRegister.UserID} onChange={handleInputChangeRegister} required />
