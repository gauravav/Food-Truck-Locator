...
import {url, googlemapsapi} from "../Helper/Helper";
...
function FoodTruckManager() {
    ...
    const { isLoaded, loadError } = useLoadScript({
        googleMapsApiKey: googlemapsapi, // Use environment variable for API key
    });
                                        ...
                                        {activeTab === 1 && <div>
                                            ...
                                            <table>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        {EditMode ? (
                                                        <input type="text" id="phoneNumber" name="phoneNumber" value={phoneNumber} onChange={handleInputChangePhoneNumber} required />) : (
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        {EditMode ? (
                                                        <input type="email" id="email" name="email" value={email} onChange={handleInputChangeEmail} required /> ) : (
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        {EditMode ? (
                                                        <input type="text" id="hours" name="hours" value={Hours} onChange={handleInputChangeHours} required />  ) : (
                                                            <p>{foodTrucks.hours}</p>)}
                                                    </td>
                                                </tr>
                                                </tbody>
                                            </table>
                                            {EditMode===false && <button type="edit" onClick={toggleEditMode}>Edit</button>}
                                            {EditMode===true &&
                                                <div>
                                        ...
                                        {activeTab === 3 && <div>
                                            <div className="cardcard-container">
                                                <div className="cardcard">
                                                    ...
                                                    <br/>
                                                    {EditMode ? (
                                                        <textarea type="text" id="notes" name="notes" value={Notes} rows="4" cols="50" onChange={handleInputChangeNotes} required />) : (
