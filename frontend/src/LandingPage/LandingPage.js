    ...
    return (
            <div className="landing-page">
                ...
                <div className="jumbotron">
                    ...
                    <p style={{  fontFamily: 'cursive', fontSize:'30px'}}>Discover food trucks near you with our interactive map.</p>
                    <div className="distance-slider">
                        <label htmlFor="distance">Distance (in miles): {distance}</label>
                        <input  type="range" id="distance" name="distance" min="1" max="25" step="1" value={distance} onChange={(e) => setDistance(parseInt(e.target.value))}/>
                    </div>
                    <button className="btn btn-primary btn-lg" onClick={fetchFoodTrucks}>Find Food Trucks by distance</button>
                    <h2 style={{  fontFamily: 'cursive', color:'black', fontStyle:'bold', fontSize:'35px'}}>or</h2>
                    <div className="autoCompleteLine">
                        <Autocomplete disablePortal id="combo-box-demo" options={allFoodTrucks} sx={{ width: 400, "& .MuiAutocomplete-input": { color: "black" }, "& .MuiAutocomplete-inputRoot": { backgroundColor: "white" } }} renderInput={(params) => <TextField {...params} style={{ color: "white" }} label="Search for Food Truck" />} value={value} onChange={handleAutocompleteChange}/>
