            ...
            <div className="card">
                {activeTab === 'login' ? (
                    ...
                    <form className="form" onSubmit={handleSubmitRegister}>
                        <label htmlFor="username">Username:</label>
                        <input type="username" id="username" name="username" value={formDataRegister.username} onChange={handleInputChangeRegister} required />
                        <label htmlFor="password">Password:</label>
                        <input type="password" id="password" name="password" value={formDataRegister.password} onChange={handleInputChangeRegister} required />
                        <label htmlFor="email">Email:</label>
                        <input type="email" id="email" name="email" value={formDataRegister.email} onChange={handleInputChangeRegister} required />
                        <label htmlFor="firstname">First Name:</label>
                        <input type="firstname" id="firstname" name="firstname" value={formDataRegister.firstname} onChange={handleInputChangeRegister} required />
                        <label htmlFor="lastname">Last Name:</label>
                        <input type="lastname" id="lastname" name="lastname" value={formDataRegister.lastname} onChange={handleInputChangeRegister} required />
