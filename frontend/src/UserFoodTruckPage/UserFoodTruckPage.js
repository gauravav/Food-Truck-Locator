        ...
        if (currentLocation && distance) {
            ...
            axios.post(url+'/getFoodTrucksByDistance', {
                ...
                .then((response) => {
                    ...
                    axios.get(url+'/getFavFoodTrucksArrayByUserId/'+Number(localStorage.getItem('FoodTruckAppID')))
                        .then((favResponse) => {
                                ...
                                >
                                    <div className='card-headline'>
                                        ...
                                        <div className="like-dislike-icons">
                                            <FontAwesomeIcon icon={foodTruck.isFav ? fasHeart : farHeart} onClick={(event) => toggleFav(foodTruck.id, event)} />
                                        </div>
                                    </div>
                                    ...
                                    <div className='cardThirdLine'>
                                        ...
                                        <button type="showOnMap" onClick={ (event) => showOnMap(foodTruck.id, event)}>Show on Map</button>
                                    </div >
                                    {foodTruck.what3words !== '' &&
                                        <span>What3Words:
                                            <span> </span>
                                            <a href={"https://what3words.com/"+foodTruck.what3words} onClick={(e) => e.stopPropagation()} target="_blank">{foodTruck.what3words}</a>
                                    </span>
                                        }
                                </div>
                            ))}
